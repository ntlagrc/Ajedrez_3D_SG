...
class Reina extends THREE.Object3D  {
  constructor(material) {
    ...
    //materiales
        ...
        const reinaMesh = new THREE.Mesh(reina,material);
        ...
        const brazoHombroMesh = new THREE.Mesh(brazoHombro,material);
        ...
        var antebrazoMesh = new THREE.Mesh(antebrazo,material);
        ...
        const manoMesh = new THREE.Mesh(mano,material);
      ...
      // Brazo izquierdo 
        ...
        const brazoHombroMeshB = new THREE.Mesh(brazoHombroB,material);
        ...
        var antebrazoMeshB = new THREE.Mesh(antebrazoB,material);
        ...
        const manoMeshB = new THREE.Mesh(manoB,material);
