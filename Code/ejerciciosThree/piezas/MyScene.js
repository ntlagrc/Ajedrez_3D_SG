...
class MyScene extends THREE.Scene {
  constructor (myCanvas) { 
    ...
    this.reina.translateX(0.5);
    this.add(this.reina);

    this.caballo = new Caballo(this.gui, "Caballo");
    this.caballo.translateX(-1);
    this.add(this.caballo);

    this.alfil = new Alfil(this.gui, "Alfil");
    this.alfil.translateX(-0.5);
    this.add(this.alfil);
    
    this.torre = new Torre(this.gui, "Torre");
    this.torre.translateX(-1.5);
    this.add(this.torre);

    this.peon = new Peon(this.gui, "Peon");
    this.peon.translateX(1);
    this.add(this.peon);

    this.rey = new Rey(this.gui, "Rey");
    this.add(this.rey);
  }
